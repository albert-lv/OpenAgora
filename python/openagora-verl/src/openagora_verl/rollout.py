...
tokenized and returned as ``responses`` in the output ``DataProto``.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._agent_image = arena_agent_image or os.environ.get("ARENA_AGENT_IMAGE", "openagora-agent-minimal:latest")
        self._llm_backend = arena_llm_backend or os.environ.get("ARENA_LLM_BACKEND", "http://localhost:8000/v1")
        self._verify_command = openagora_verify_command or os.environ.get("ARENA_VERIFY_COMMAND", "true")
