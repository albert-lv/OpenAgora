...
When using veRL's TransferQueue-based sync trainer, explicitly install the
OpenAgora adapter before starting training:
...
No changes to veRL or TransferQueue source code are required.
