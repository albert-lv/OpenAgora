...
class TrainingService:
    ...
    def subscribe(self) -> asyncio.Queue:
        """Return a queue that receives every newly appended metric record."""
    ...
    def _notify(self, record: dict):
        ...
        for queue in self._subscribers:
            try:
                # put_nowait is safe because asyncio.Queue is thread-safe for
                # putting from a different thread as long as the loop is running.
