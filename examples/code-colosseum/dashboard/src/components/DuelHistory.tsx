        ...
        <ul className="space-y-2 max-h-96 overflow-auto">
          {duels.map((duel) => (
            ...
            >
              ...
              {(duel.agent_a.estimated_cost_usd || duel.agent_b.estimated_cost_usd) ? (
                <div className="text-xs text-slate-500 mt-1">
                  Cost: ${(duel.agent_a.estimated_cost_usd || 0).toFixed(4)} / ${(duel.agent_b.estimated_cost_usd || 0).toFixed(4)}
                </div>
              ) : null}
              {duel.winner && (
