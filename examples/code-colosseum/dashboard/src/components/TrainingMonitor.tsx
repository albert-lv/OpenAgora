    ...
    <div className="bg-slate-900 rounded-lg border border-slate-700 p-4 space-y-4">
      <div className="flex items-center justify-between">
        ...
        <span className={`px-2 py-0.5 rounded text-xs font-semibold ${
          status?.running ? 'bg-green-900 text-green-200' : 'bg-slate-800 text-slate-300'
        }`}>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <Metric label="KL" value={status?.kl ?? 0} />
      </div>
      ...
      <div className="h-64">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={history}>
            ...
            <Line type="monotone" dataKey="value_loss" stroke="#f472b6" strokeWidth={2} dot={false} />
